<!-- Verbatim 42 CFR Part 2 text as amended by the 2024 final rule (89 FR 12472; compliance date
February 16, 2026). Extracted 2026-06-11 from the Rote regulatory knowledge base
(wiki_regulatory_42cfr_part2). Do not paraphrase when classifying; quote from this text. -->

# Reference: Applicability and Definitions (gate, D2, D7, D10)

## § 2.11 — Definitions (selected)
...
### § 2.11 — Federally assisted

Federally assisted —see § 2.12(b).

### § 2.11 — Qualified service organization
...
### § 2.11 — Patient identifying information
...
### § 2.11 — Substance use disorder (SUD) counseling notes
